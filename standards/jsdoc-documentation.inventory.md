...
- `src/TaxonomyRegistry.ts:35` `LibrarianInput` (class) - 1 example import violation(s)
- `src/TaxonomyRegistry.ts:104` `TaxonomyConceptNotFound` (class) - 1 example import violation(s)
- `src/TaxonomyRegistry.ts:126` `UnsupportedDocumentClass` (class) - 1 example import violation(s)
- `src/TaxonomyRegistry.ts:157` `runLibrarianLoop` (const) - 2 example import violation(s)
...
- `src/values/LocalDate/LocalDate.behavior.ts:703` `LocalDateFromString` (const) - 1 example import violation(s)
...
- `src/FaceDetection.service.ts:894` `withDetector` (const) - 1 example import violation(s)
...
- `src/commands/Cache/Cache.command.ts:383` `buildCacheDashboard` (const) - 1 example import violation(s)
- `src/commands/Cache/Cache.command.ts:438` `runCacheRestorationProbe` (const) - 1 example import violation(s)
...
- `src/commands/Ci/CiLane.ts:1522` `runCiLane` (const) - 1 example import violation(s)
- `src/commands/Ci/CiLane.ts:1573` `ciLaneCommand` (const) - 1 example import violation(s)
- `src/commands/Ci/CiLane.ts:1912` `runCiLocal` (const) - 1 example import violation(s)
- `src/commands/Ci/CiLane.ts:1948` `ciLocalCommand` (const) - 1 example import violation(s)
...
- `src/commands/DeletePackage/DeletePackage.command.ts:381` `rewritePendingChangesets` (const) - 1 example import violation(s)
...
- `src/commands/Lint/RoadmapRefs.ts:298` `runRoadmapRefsLint` (const) - 1 example import violation(s)
...
- `src/commands/Qa/Control.ts:91` `stopLiveSession` (const) - 1 example import violation(s)
- `src/commands/Qa/Control.ts:120` `markLiveSession` (const) - 1 example import violation(s)
...
- `src/commands/Qa/JudgeIngest.ts:169` `runQaJudgeIngest` (const) - 1 example import violation(s)
...
- `src/commands/Quality/Quality.command.ts:789` `devQualityStepsForTesting` (const) - 1 example import violation(s)
...
- `src/commands/Quality/Quality.schemas.ts:322` `decodePackageJsonDocument` (const) - 1 example import violation(s)
- `src/commands/Quality/Quality.schemas.ts:721` `decodeGithubChecksFallowFeatureMatrix` (const) - 1 example import violation(s)
...
- `src/Service/FileProcessing.layer.ts:112` `makeFileProcessingServiceLayer` (const) - 1 example import violation(s)
...
- `src/SourceText/SourceText.paging.ts:111` `pageSourceText` (const) - 2 example import violation(s)
- `src/SourceText/SourceText.paging.ts:152` `pageSourceTextContainingOffset` (const) - 2 example import violation(s)
...
Export findings:
- `src/SourceText/WorkspaceSourceTextResolver.ts:345` `WorkspaceSourceTextResolverLayer` (const) - 1 example import violation(s)
...
- `src/OpenclawCli.service.ts:750` `OpenclawCli` (class) - 1 example import violation(s)
...
- `beep-docs/api-reference/Reflection.ts:242` `loadReflection` (const) - 1 example import violation(s)
...
- `effect-ontology/Runtime/AuthRouter.ts:165` `AuthRouter` (const) - 1 example import violation(s)
...
- `effect-ontology/Runtime/EventBroadcastRouter.ts:774` `broadcastDomainEvent` (const) - 1 example import violation(s)
...
- `effect-ontology/Service/EventBus.ts:346` `EventBusServiceMemory` (const) - 1 example import violation(s)
- `effect-ontology/Service/EventBus.ts:562` `EventBusServiceSql` (const) - 1 example import violation(s)
- `effect-ontology/Service/EventBus.ts:765` `EventBusServiceSqlLayers` (const) - 1 example import violation(s)
- `effect-ontology/Service/EventBus.ts:803` `EventBusServiceSqlLive` (const) - 1 example import violation(s)
- `effect-ontology/Service/EventBus.ts:830` `EventBusServiceDefault` (const) - 1 example import violation(s)
...
- `effect-ontology/Service/ImageFetcher.ts:269` `ImageFetcher` (class) - 1 example import violation(s)
...
- `effect-ontology/Service/SubgraphExtractor.ts:404` `SubgraphExtractorDefault` (const) - 1 example import violation(s)
...
- `effect-ontology/Service/VoyageEmbeddingProvider.ts:634` `VoyageEmbeddingProviderDefault` (const) - 1 example import violation(s)
- `effect-ontology/Service/WikidataClient.ts:89` `WikidataRateLimitError` (class) - 1 example import violation(s)
- `effect-ontology/Service/WikidataClient.ts:405` `WikidataClient` (class) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:211` `BatchExtractionWorkflow` (const) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:341` `pollToBatchState` (const) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:383` `BatchExtractionWorkflowLayer` (const) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:1097` `WorkflowOrchestrator` (class) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:1128` `makeWorkflowOrchestrator` (const) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:1185` `WorkflowOrchestratorLive` (const) - 1 example import violation(s)
- `effect-ontology/Service/WorkflowOrchestrator.ts:1218` `WorkflowOrchestratorFullLive` (const) - 1 example import violation(s)
...
- `effect-ontology/Workflow/StreamingExtraction.ts:830` `ExtractionWorkflowLive` (const) - 1 example import violation(s)
- `effect-ontology/Workflow/StreamingExtractionActivity.ts:237` `buildRunConfig` (const) - 1 example import violation(s)
- `effect-ontology/Workflow/StreamingExtractionActivity.ts:338` `enrichEntityMetadata` (const) - 2 example import violation(s)
...
- `memfs/internal/volume.ts:2826` `make` (const) - 1 example import violation(s)
- `memfs/internal/volume.ts:3004` `makeInspectable` (const) - 1 example import violation(s)
- `memfs/internal/volume.ts:3033` `layer` (const) - 1 example import violation(s)
...
- `src/IrToLaw/IrToLaw.service.ts:183` `makeIrToLaw` (const) - 1 example import violation(s)
...
- `src/Option.ts:108` `getSomesStruct` (const) - 1 example import violation(s)
...
- `src/Str.ts:830` `export * from "effect/String";` (re-export) - 1 example import violation(s)
...
- `src/Str.ts:158` `prefixThunk` (const) - 2 example import violation(s)
- `src/Str.ts:210` `postfix` (const) - 2 example import violation(s)
- `src/Str.ts:250` `postfixThunk` (const) - 2 example import violation(s)
- `src/Str.ts:290` `mapPrefix` (const) - 2 example import violation(s)
- `src/Str.ts:339` `mapPostfix` (const) - 2 example import violation(s)
- `src/Str.ts:374` `camelCase` (const) - 1 example import violation(s)
- `src/Str.ts:392` `snakeCase` (const) - 1 example import violation(s)
- `src/Str.ts:410` `kebabCase` (const) - 1 example import violation(s)
- `src/Str.ts:429` `screamingSnake` (const) - 1 example import violation(s)
- `src/Str.ts:448` `pascalCase` (const) - 1 example import violation(s)
- `src/Str.ts:466` `pascalToSnake` (const) - 1 example import violation(s)
- `src/Str.ts:485` `snakeToCamel` (const) - 1 example import violation(s)
- `src/Str.ts:504` `snakeToKebab` (const) - 1 example import violation(s)
- `src/Str.ts:523` `camelToSnake` (const) - 1 example import violation(s)
- `src/Str.ts:542` `snakeToPascal` (const) - 1 example import violation(s)
- `src/Str.ts:561` `kebabToSnake` (const) - 1 example import violation(s)
- `src/Str.ts:588` `startsWith` (const) - 2 example import violation(s)
- `src/Str.ts:628` `endsWith` (const) - 2 example import violation(s)
- `src/Str.ts:673` `contains` (const) - 2 example import violation(s)
- `src/Str.ts:717` `repeat` (const) - 2 example import violation(s)
- `src/Str.ts:753` `replaceWith` (const) - 2 example import violation(s)
- `src/Str.ts:797` `replaceAllWith` (const) - 2 example import violation(s)
- `src/Str.ts:850` `trimThunk` (const) - 1 example import violation(s)
- `src/Str.ts:870` `fromNumber` (const) - 1 example import violation(s)
- `src/Str.ts:887` `toSlug` (const) - 1 example import violation(s)
- `src/Str.ts:925` `truncate` (const) - 2 example import violation(s)
- `src/Str.ts:951` `orEmpty` (const) - 1 example import violation(s)
- `src/Str.ts:999` `matchEmpty` (const) - 1 example import violation(s)
...
- `src/Struct.ts:214` `dotGetOption` (const) - 2 example import violation(s)
- `src/Struct.ts:277` `mapPath` (const) - 2 example import violation(s)
- `src/Struct.ts:355` `mapPathLazy` (const) - 1 example import violation(s)
- `src/Struct.ts:437` `getLazy` (const) - 2 example import violation(s)
- `src/Struct.ts:472` `pathsOf` (const) - 1 example import violation(s)
- `src/Struct.ts:592` `entriesNonEmpty` (const) - 1 example import violation(s)
- `src/Struct.ts:623` `keys` (const) - 1 example import violation(s)
- `src/Struct.ts:649` `keysNonEmpty` (const) - 1 example import violation(s)
- `src/Struct.ts:684` `fromEntries` (const) - 1 example import violation(s)
- `src/Struct.ts:792` `reverse` (const) - 1 example import violation(s)
- `src/Struct.ts:912` `deepMerge` (const) - 1 example import violation(s)
...
Export findings:
- `src/agent-effectiveness.ts:2935` `makeAgentEffectivenessDoctorReport` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:3302` `makeAgentEffectivenessAnnotationPlan` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:3541` `makeAgentEffectivenessDatasetBundle` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:3912` `syncAgentEffectivenessPhoenix` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4280` `makeAgentEffectivenessAnnotationCheckReport` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4337` `agentEffectivenessDoctorReportToJson` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4389` `agentEffectivenessAnnotationPlanToJson` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4432` `agentEffectivenessAnnotationCheckReportToJson` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4475` `agentEffectivenessDatasetBundleToJson` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4512` `agentEffectivenessPromptBundleToJson` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4556` `agentEffectivenessExperimentBundleToJson` (const) - 1 example import violation(s)
- `src/agent-effectiveness.ts:4605` `agentEffectivenessPhoenixSyncResultToJson` (const) - 1 example import violation(s)
...
- `src/Tika.response.ts:158` `readTikaContentText` (const) - 1 example import violation(s)
...
- `src/VeniceAI.service.ts:2047` `VeniceAI` (class) - 1 example import violation(s)
- `src/VeniceAI.service.ts:2120` `VeniceAiChat` (class) - 1 example import violation(s)
...
- `src/Curie.ts:266` `expand` (const) - 1 example import violation(s)
- `src/Curie.ts:314` `contract` (const) - 1 example import violation(s)
- `src/Curie.ts:370` `expandPredicate` (const) - 1 example import violation(s)
- `src/Curie.ts:390` `makeCurieCodec` (const) - 1 example import violation(s)
- `src/Curie.ts:410` `CoreCurieCodec` (const) - 1 example import violation(s)
- `src/Curie.ts:428` `makeCurieFromIri` (const) - 1 example import violation(s)
- `src/Curie.ts:452` `CurieFromIri` (const) - 1 example import violation(s)
...
- `src/IdentityRegistry.ts:31` `IdentityEncoding` (const) - 1 example import violation(s)
- `src/IdentityRegistry.ts:63` `IdentityRef` (const) - 1 example import violation(s)
- `src/IdentityRegistry.ts:101` `IdentityEntry` (class) - 1 example import violation(s)
- `src/IdentityRegistry.ts:178` `IdentityNotFoundError` (class) - 1 example import violation(s)
- `src/IdentityRegistry.ts:206` `IdentityRegistryConflictError` (class) - 1 example import violation(s)
- `src/IdentityRegistry.ts:248` `IdentityRegistry` (class) - 2 example import violation(s)
...
- `src/OpenAiCompatLanguageModel.service.ts:963` `makeFromProvider` (const) - 1 example import violation(s)
- `src/OpenAiCompatLanguageModel.service.ts:1012` `layerFromProvider` (const) - 1 example import violation(s)
...
- `src/Graph/EffectGraph.ts:602` `GraphCoalgebra` (type) - 1 example import violation(s)
- `src/Graph/EffectGraph.ts:624` `ana` (const) - 1 example import violation(s)
- `src/Graph/EffectGraph.ts:668` `map` (const) - 1 example import violation(s)
- `src/Graph/EffectGraph.ts:722` `toArray` (const) - 1 example import violation(s)
- `src/Graph/EffectGraph.ts:762` `show` (const) - 1 example import violation(s)
...
Export findings:
- `src/chat/ChatOrchestrator.ts:1140` `makeChatOperations` (const) - 1 example import violation(s)
- `src/chat/ChatOrchestrator.ts:1192` `ChatHandlersLive` (const) - 1 example import violation(s)
...
- `src/transport/TauriIpcSocket.ts:505` `TauriIpcSocketLive` (const) - 1 example import violation(s)
...
- `src/Firecrawl.service.ts:757` `Firecrawl` (class) - 1 example import violation(s)
...
- `src/TSMorph/TSMorph.service.ts:696` `createTSMorphService` (const) - 1 example import violation(s)
- `src/TSMorph/TSMorph.service.ts:1366` `TSMorphServiceLive` (const) - 1 example import violation(s)
...
- `src/schemas/TSConfig.ts:1962` `decodeTSConfigEffect` (const) - 1 example import violation(s)
- `src/schemas/TSConfig.ts:1996` `decodeTSConfigFromJsoncTextEffect` (const) - 1 example import violation(s)
- `src/schemas/TSConfig.ts:2025` `encodeTSConfigEffect` (const) - 1 example import violation(s)
- `src/schemas/TSConfig.ts:2048` `encodeTSConfigToJsonEffect` (const) - 1 example import violation(s)
- `src/schemas/TSConfig.ts:2076` `encodeTSConfigPrettyEffect` (const) - 1 example import violation(s)
...
- `src/Duration/Duration.input.ts:292` `DurationFromInput` (const) - 1 example import violation(s)
- `src/Duration/Duration.input.ts:323` `DurationFromInput` (type) - 1 example import violation(s)
...
- `src/Graph/Graph.shared.ts:395` `makeGraphEquivalence` (const) - 1 example import violation(s)
- `src/Graph/Graph.shared.ts:469` `isImmutableGraphValue` (const) - 1 example import violation(s)
- `src/Graph/Graph.shared.ts:489` `isMutableGraphValue` (const) - 1 example import violation(s)
...
- `src/Jsonl.ts:108` `JsonlTextToUnknown` (const) - 1 example import violation(s)
- `src/Jsonl.ts:152` `decodeJsonlTextAs` (const) - 1 example import violation(s)
...
- `src/Markdown.ts:183` `MarkdownTextToHtml` (const) - 1 example import violation(s)
- `src/Markdown.ts:221` `decodeMarkdownTextAs` (const) - 1 example import violation(s)
...
- `src/SchemaUtils/withCodecStatics.ts:426` `withCodecStatics` (const) - 1 example import violation(s)
...
- `src/Semver.ts:651` `SemverFromString` (const) - 1 example import violation(s)
...
Export findings:
- `src/BoxProvisioning.ts:182` `BoxProvisioning` (class) - 1 example import violation(s)
...
- `src/XAi.service.ts:1032` `XAi` (class) - 1 example import violation(s)
...
- `src/hooks/useNumberInput.ts:484` `getStepFactor` (const) - 1 example import violation(s)
...
- `src/WinkCorpus.service.ts:826` `WinkCorpusManager` (class) - 1 example import violation(s)
- `src/WinkCorpus.service.ts:856` `WinkCorpusManagerLive` (const) - 1 example import violation(s)
...
- `src/WinkTokenization.service.ts:378` `WinkTokenization` (const) - 1 example import violation(s)
- `src/WinkTokenization.service.ts:401` `WinkTokenizationLive` (const) - 1 example import violation(s)
