...
Generated: 2026-07-09T19:57:37.092Z
...
| 16 | `@beep/ontology-use-cases` | `packages/ontology/use-cases` | clean | 19 | 151 | 0 | 0 |
...
| 31 | `@beep/ontology-server` | `packages/ontology/server` | clean | 6 | 14 | 0 | 0 |
...
| 62 | `@beep/ontology-ui` | `packages/ontology/ui` | clean | 5 | 7 | 0 | 0 |
...
| 66 | `@beep/shacl` | `packages/drivers/shacl` | clean | 3 | 6 | 0 | 0 |
...
| 69 | `@beep/professional-desktop` | `apps/professional-desktop` | clean | 28 | 51 | 0 | 0 |
| 70 | `@beep/epistemic-domain` | `packages/epistemic/domain` | clean | 22 | 44 | 0 | 0 |
| 71 | `@beep/ontology-client` | `packages/ontology/client` | clean | 3 | 61 | 0 | 0 |
...
| 75 | `@beep/oxigraph` | `packages/drivers/oxigraph` | clean | 3 | 6 | 0 | 0 |
| 76 | `@beep/acp` | `packages/drivers/acp` | clean | 10 | 410 | 0 | 0 |
| 77 | `@beep/nlp` | `packages/foundation/modeling/nlp` | clean | 28 | 310 | 0 | 0 |
| 78 | `@beep/infra` | `infra` | clean | 5 | 34 | 0 | 0 |
| 79 | `@beep/runpod` | `packages/drivers/runpod` | clean | 6 | 179 | 0 | 0 |
| 80 | `@beep/fc-runs` | `packages/tooling/test-kit/fc-runs` | clean | 2 | 5 | 0 | 0 |
| 81 | `@beep/repo-utils` | `packages/tooling/library/repo-utils` | clean | 63 | 677 | 0 | 0 |
| 82 | `@beep/schema` | `packages/foundation/modeling/schema` | clean | 241 | 1569 | 0 | 0 |
...
| 110 | `@beep/sanity` | `packages/drivers/sanity` | clean | 4 | 16 | 0 | 0 |
