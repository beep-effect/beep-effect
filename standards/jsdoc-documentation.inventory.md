...
Generated: 2026-09-04T06:41:11.987Z
...
| 19 | `@beep/repo-cli` | `packages/tooling/tool/cli` | needs-remediation | 226 | 1862 | 47 | 283 |
...
- `src/commands/Quality/Quality.command.ts:774` `runBunAudit` (const) - 1 documentation section/link violation(s)
- `src/commands/Quality/Quality.command.ts:900` `devQualityStepsForTesting` (const) - 1 example import violation(s)
