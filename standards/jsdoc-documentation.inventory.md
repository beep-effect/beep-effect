...
Generated: 2026-07-10T20:46:01.773Z
...
| 17 | `@beep/ontology-use-cases` | `packages/ontology/use-cases` | clean | 11 | 46 | 0 | 0 |
...
| 44 | `@beep/ontology-domain` | `packages/ontology/domain` | clean | 6 | 30 | 0 | 0 |
...
| 65 | `@beep/documents-server` | `packages/documents/server` | clean | 6 | 11 | 0 | 0 |
...
| 68 | `@beep/professional-desktop` | `apps/professional-desktop` | clean | 29 | 58 | 0 | 0 |
...
| 79 | `@beep/documents-domain` | `packages/documents/domain` | clean | 11 | 39 | 0 | 0 |
| 80 | `@beep/schema` | `packages/foundation/modeling/schema` | clean | 253 | 1604 | 0 | 0 |
...
| 108 | `@beep/documents-use-cases` | `packages/documents/use-cases` | clean | 9 | 29 | 0 | 0 |
