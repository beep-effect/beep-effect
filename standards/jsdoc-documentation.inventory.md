...
Generated: 2026-09-09T04:20:43.649Z
...
| 19 | `@beep/repo-cli` | `packages/tooling/tool/cli` | needs-remediation | 226 | 1867 | 47 | 283 |
...
| 66 | `@beep/utils` | `packages/foundation/modeling/utils` | needs-remediation | 29 | 216 | 6 | 118 |
...
| 97 | `@beep/schema` | `packages/foundation/modeling/schema` | needs-remediation | 263 | 1608 | 26 | 170 |
...
| 121 | `@beep/ui` | `packages/foundation/ui-system/ui` | needs-remediation | 134 | 555 | 1 | 7 |
...
Export findings:
- `src/HubSpot.service.ts:351` `HubSpotShape` (type) - 1 example import violation(s)
...
- `src/Pacer.mock-data.ts:157` `defaultCasePages` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:178` `loopingCaseReportBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:197` `defaultPartyBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:215` `authSuccessBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:239` `authInvalidBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:263` `logoutBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:287` `logoutInvalidBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:365` `reportInfoBody` (const) - 1 example import violation(s)
- `src/Pacer.mock-data.ts:400` `downloadResultsBody` (const) - 1 example import violation(s)
...
- `src/commands/Cache/Cache.command.ts:224` `runCacheWarm` (const) - 1 example import violation(s)
- `src/commands/Cache/Cache.command.ts:250` `runCacheWarmForTesting` (const) - 1 example import violation(s)
- `src/commands/Cache/Cache.command.ts:409` `buildCacheDashboard` (const) - 1 example import violation(s)
- `src/commands/Cache/Cache.command.ts:464` `runCacheRestorationProbe` (const) - 1 example import violation(s)
...
- `src/commands/Ci/CiLane.ts:1304` `ciLaneStepsForTesting` (const) - 1 documentation section/link violation(s)
...
- `src/commands/DeletePackage/DeletePackage.command.ts:379` `rewritePendingChangesets` (const) - 1 example import violation(s)
...
- `src/commands/Goals/Adopt.ts:165` `readPacketSnapshot` (const) - 1 example import violation(s)
- `src/commands/Goals/Bootstrap.ts:721` `renderMaterializationPlanJson` (const) - 1 example import violation(s)
...
- `src/commands/Goals/Migration/PacketMutation.ts:101` `PacketForkRepairApplier` (class) - 1 example import violation(s)
- `src/commands/Goals/Migration/PacketMutation.ts:496` `isRecoverableGenesisSeed` (const) - 1 example import violation(s)
- `src/commands/Goals/Migration/PacketMutation.ts:614` `planPacketGenesisRecovery` (const) - 1 example import violation(s)
- `src/commands/Goals/Migration/PacketMutation.ts:668` `planPacketGenesisSeed` (const) - 1 example import violation(s)
- `src/commands/Goals/Migration/PacketMutation.ts:753` `quarantineOwnedGenesisEvents` (const) - 1 example import violation(s)
...
- `src/commands/Laws/NoNativeRuntime.ts:574` `runNoNativeRuntimeRules` (const) - 1 documentation section/link violation(s)
...
- `src/commands/Qa/Extract.ts:147` `extractionPlanPath` (const) - 1 example import violation(s)
- `src/commands/Qa/Extract.ts:188` `artifactBudgetPath` (const) - 1 example import violation(s)
- `src/commands/Qa/Extract.ts:210` `writeArtifactBudget` (const) - 1 example import violation(s)
- `src/commands/Qa/Extract.ts:236` `readArtifactBudget` (const) - 1 example import violation(s)
- `src/commands/Qa/Extract.ts:260` `readExtractionPlan` (const) - 1 example import violation(s)
- `src/commands/Qa/Extract.ts:322` `resolveRoundLayout` (const) - 1 example import violation(s)
- `src/commands/Qa/Extract.ts:788` `runQaExtract` (const) - 1 example import violation(s)
...
- `src/commands/Qa/JudgePack.ts:543` `renderTimeline` (const) - 1 documentation section/link violation(s)
- `src/commands/Qa/JudgePack.ts:644` `selectJudgeEvidence` (const) - 1 documentation section/link violation(s)
- `src/commands/Qa/JudgePack.ts:839` `runQaJudgePack` (const) - 1 example import violation(s)
...
- `src/commands/Qa/Qa.session.ts:63` `qaRootPath` (const) - 1 example import violation(s)
- `src/commands/Qa/Qa.session.ts:195` `resolveAppHostTarget` (const) - 1 example import violation(s)
- `src/commands/Qa/Qa.session.ts:315` `resolveCaptureTarget` (const) - 1 example import violation(s)
...
- `src/commands/Qa/Qa.session.ts:702` `readRecordStartHint` (const) - 1 example import violation(s)
- `src/commands/Qa/Qa.session.ts:729` `writeRecordStartHint` (const) - 1 example import violation(s)
- `src/commands/Qa/Qa.session.ts:762` `discoverRecordedVideo` (const) - 1 example import violation(s)
...
- `src/commands/Quality/Quality.command.ts:778` `runBunAudit` (const) - 1 documentation section/link violation(s)
- `src/commands/Quality/Quality.command.ts:904` `devQualityStepsForTesting` (const) - 1 example import violation(s)
...
- `src/commands/Runners/Runners.service.ts:159` `BakeLocalInputs` (class) - 1 example import violation(s)
- `src/commands/Runners/Runners.service.ts:208` `RunnersService` (class) - 1 example import violation(s)
...
- `src/validation.ts:398` `validateRepoConfig` (const) - 1 example import violation(s)
- `src/validation.ts:441` `validateRepoSafetyPolicy` (const) - 1 example import violation(s)
- `src/validation.ts:482` `validateDogfoodConfig` (const) - 1 example import violation(s)
- `src/validation.ts:510` `validateDogfoodConfigs` (const) - 1 example import violation(s)
- `src/validation.ts:536` `defaultRepoRoot` (const) - 1 example import violation(s)
- `src/validation.ts:564` `validateCurrentCheckoutDogfood` (const) - 1 example import violation(s)
- `src/validation.ts:593` `validateCurrentCheckoutDogfoodConfigs` (const) - 1 example import violation(s)
...
- `src/Lexical.codec.ts:394` `blockToLexical` (const) - 1 example import violation(s)
...
- `claudecode/Testing.ts:263` `RunHookResult` (class) - 1 example import violation(s)
...
- `codemode/Codemode.tool-runtime.ts:1107` `prepare` (const) - 1 example import violation(s)
- `codemode/Codemode.tool-runtime.ts:1142` `searchIndex` (const) - 1 example import violation(s)
- `codemode/Codemode.tool-runtime.ts:1319` `make` (const) - 1 example import violation(s)
...
- `codemode/interpreter/Interpreter.errors.ts:252` `constructAggregateErrorValue` (const) - 1 example import violation(s)
...
- `codemode/interpreter/Interpreter.methods.ts:603` `invokeArrayFrom` (const) - 1 example import violation(s)
- `codemode/interpreter/Interpreter.methods.ts:686` `invokeGroupBy` (const) - 1 example import violation(s)
- `codemode/interpreter/Interpreter.methods.ts:890` `applyCollectionCallback` (const) - 1 example import violation(s)
...
- `codemode/interpreter/Interpreter.runtime.ts:479` `Interpreter` (class) - 1 example import violation(s)
...
- `codemode/openapi/OpenAPI.specification.ts:1351` `validateBaseUrl` (const) - 1 example import violation(s)
- `codemode/openapi/OpenAPI.specification.ts:1393` `specServerUrl` (const) - 1 example import violation(s)
- `codemode/openapi/OpenAPI.specification.ts:1431` `securityRequirements` (const) - 1 example import violation(s)
- `codemode/openapi/OpenAPI.specification.ts:1496` `operationSecurityRequirements` (const) - 1 example import violation(s)
- `codemode/openapi/OpenAPI.specification.ts:1583` `securitySchemes` (const) - 1 example import violation(s)
...
- `effect-ontology/Domain/Schema/KnowledgeModel.ts:818` `EntityRef` (class) - 1 example import violation(s)
...
- `effect-ontology/Repository/Conflict.ts:213` `canonicalConflictPair` (const) - 1 example import violation(s)
- `effect-ontology/Repository/Conflict.ts:354` `ConflictRepository` (class) - 1 example import violation(s)
- `effect-ontology/Repository/Embedding.ts:130` `HybridSearchResult` (class) - 1 example import violation(s)
- `effect-ontology/Repository/Embedding.ts:482` `EmbeddingRepository` (class) - 1 example import violation(s)
...
- `effect-ontology/Service/Agent/AgentCoordinator.ts:136` `ExecutionHooks` (interface) - 1 example import violation(s)
- `effect-ontology/Service/Agent/AgentCoordinator.ts:205` `ExecutionResult` (class) - 1 example import violation(s)
- `effect-ontology/Service/Agent/AgentCoordinator.ts:286` `AgentCoordinator` (class) - 1 example import violation(s)
...
- `effect-ontology/Service/Nlp.ts:161` `TextChunk` (const) - 1 example import violation(s)
- `effect-ontology/Service/Nlp.ts:394` `OntologySearchResult` (const) - 1 example import violation(s)
- `effect-ontology/Service/Nlp.ts:673` `NlpService` (class) - 1 example import violation(s)
...
- `effect-ontology/Service/Ontology.ts:244` `parseOntologyFromStore` (const) - 1 example import violation(s)
- `effect-ontology/Service/Ontology.ts:637` `OntologyService` (class) - 1 example import violation(s)
...
- `effect-ontology/Service/PubSubClient.ts:255` `PubSubClientConfig` (const) - 1 example import violation(s)
- `effect-ontology/Service/PubSubClient.ts:222` `PubSubClient` (class) - 1 example import violation(s)
- `effect-ontology/Service/PubSubClient.ts:293` `PubSubClientLive` (const) - 1 example import violation(s)
- `effect-ontology/Service/PubSubClient.ts:468` `EventBusPubSubBridge` (const) - 1 example import violation(s)
- `effect-ontology/Service/PubSubClient.ts:510` `PubSubClientDefault` (const) - 1 example import violation(s)
...
- `effect-ontology/Service/Retry.ts:153` `RetryPolicyInput` (type) - 1 example import violation(s)
- `effect-ontology/Service/Retry.ts:291` `retryEffect` (const) - 1 example import violation(s)
...
- `effect-ontology/Service/Ticket.ts:263` `TicketService` (class) - 1 example import violation(s)
- `effect-ontology/Service/Ticket.ts:292` `TicketServiceLive` (const) - 1 example import violation(s)
...
- `effect-ontology/Workflow/StreamingExtraction.ts:180` `makeExtractionWorkflow` (const) - 1 example import violation(s)
- `effect-ontology/Workflow/StreamingExtraction.ts:829` `ExtractionWorkflowLive` (const) - 1 example import violation(s)
...
- `toml/TomlFormat.ts:934` `TomlFormat` (class) - 1 example import violation(s)
...
- `src/archive.ts:274` `AiMetricsRawArchiveKey` (const) - 1 example import violation(s)
- `src/archive.ts:296` `AiMetricsRawArchiveKey` (type) - 1 example import violation(s)
- `src/archive.ts:423` `writeEncryptedRawArchiveObject` (const) - 1 example import violation(s)
- `src/archive.ts:540` `decryptEncryptedRawArchiveEnvelope` (const) - 1 example import violation(s)
...
Export findings:
- `src/VeniceAI.service.ts:419` `VeniceAIConfigInput` (class) - 1 example import violation(s)
- `src/VeniceAI.service.ts:1386` `VENICE_AI_OPERATION_DESCRIPTORS` (const) - 2 example import violation(s)
- `src/VeniceAI.service.ts:2042` `VeniceAI` (class) - 1 example import violation(s)
- `src/VeniceAI.service.ts:2115` `VeniceAiChat` (class) - 1 example import violation(s)
...
- `src/Id.ts:1633` `BaseIdentityInput` (const) - 1 example import violation(s)
- `src/Id.ts:1662` `BaseIdentityInput` (type) - 1 example import violation(s)
- `src/Id.ts:2178` `make` (const) - 2 example import violation(s)
...
- `src/AcpProtocol.service.ts:50` `AcpUnknownExtRequestHandler` (type) - 1 example import violation(s)
- `src/AcpProtocol.service.ts:71` `AcpUnknownExtNotificationHandler` (type) - 1 example import violation(s)
- `src/AcpProtocol.service.ts:97` `AcpExtensionRegistrars` (interface) - 1 example import violation(s)
- `src/AcpProtocol.service.ts:486` `makeAcpPatchedProtocol` (const) - 2 example import violation(s)
...
- `src/SchemaUtils/withCodecStatics.ts:423` `withCodecStatics` (const) - 1 example import violation(s)
...
- `src/Sha256.ts:117` `Sha256HexFromBytes` (const) - 1 example import violation(s)
- `src/Sha256.ts:150` `Sha256HexFromBytes` (type) - 1 example import violation(s)
- `src/Sha256.ts:173` `Sha256HexFromHexBytes` (const) - 1 example import violation(s)
- `src/Sha256.ts:200` `Sha256HexFromHexBytes` (type) - 1 example import violation(s)
...
- `src/Html.conformance.ts:2260` `conform` (const) - 1 example import violation(s)
- `src/Html.conformance.ts:2292` `conformantRoot` (const) - 1 example import violation(s)
...
- `src/Html.policy.ts:348` `SafeImageUrlAttribute` (type) - 1 example import violation(s)
- `src/Html.policy.ts:397` `HtmlPolicyRule` (type) - 1 example import violation(s)
- `src/Html.policy.ts:503` `SafeHtmlAst` (const) - 2 example import violation(s)
- `src/Html.policy.ts:530` `SafeHtmlAst` (type) - 2 example import violation(s)
- `src/Html.policy.ts:551` `SafeHtmlNode` (const) - 2 example import violation(s)
- `src/Html.policy.ts:807` `inspectSafeHtml` (const) - 2 example import violation(s)
- `src/Html.policy.ts:837` `enforceSafeHtml` (const) - 2 example import violation(s)
- `src/Html.policy.ts:864` `safeHtmlAstConformant` (const) - 2 example import violation(s)
- `src/Html.policy.ts:893` `safeHtmlAstRoot` (const) - 2 example import violation(s)
...
Export findings:
- `src/N3.service.ts:346` `N3TurtleCodec` (class) - 1 example import violation(s)
