...
[R1] `upstream/dkg/README.md`: lines 10-16, 19-38, 68-83, 122-170, 203-217, 221-307, 313-330, 379-480, 483-529, 564-581, 600-628, 646-678.

[R2] `upstream/dkg/docs/use-dkg/funding.md`: lines 8-16, 18-27, 29-42. `upstream/dkg/docs/use-dkg/run-node.md`: lines 22-39, 47-73. `upstream/dkg/packages/chain/src/no-chain-adapter.ts`: lines 15-26.

[R3] `upstream/dkg/LICENSE`: lines 1-3, 66-87, 89-128, 189-201.

[R4] `upstream/dkg/package.json`: lines 1-13, 83-93. `upstream/dkg/packages/storage/package.json`: lines 1-16, 24-29. `upstream/dkg/packages/query/package.json`: lines 1-16, 24-29. `upstream/dkg/packages/mcp-dkg/package.json`: lines 1-36, 44-63. `upstream/dkg/packages/chain/package.json`: lines 1-20, 30-36. `upstream/dkg/packages/publisher/package.json`: lines 1-20, 31-36.

[R5] `upstream/dkg/ARCHITECTURE.md`: lines 1-5, 17-133, 344-384, 410-560.

[R6] `upstream/dkg/packages/storage/README.md`: lines 1-15, 36-67. `upstream/dkg/packages/storage/src/triple-store.ts`: lines 1-5, 55-124, 181-217. `upstream/dkg/packages/storage/src/index.ts`: lines 34-50.

[R7] `upstream/dkg/docs/use-dkg/storage-sparql-http.md`: lines 8-14, 16-43, 45-68, 90-94. `upstream/dkg/packages/storage/src/adapters/oxigraph.ts`: lines 25-43, 45-93, 116-139, 194-218, 242-247. `upstream/dkg/packages/storage/src/adapters/oxigraph-worker.ts`: lines 8-35, 65-73, 146-247. `upstream/dkg/packages/storage/src/adapters/sparql-http.ts`: lines 1-22, 114-145, 166-253. `upstream/dkg/packages/storage/src/adapters/blazegraph.ts`: lines 15-22, 36-52, 112-164, 189-211.

[R8] `upstream/dkg/ARCHITECTURE.md`: lines 562-593, 641-669, 705-759. `upstream/dkg/packages/storage/src/private-store.ts`: lines 21-26, 180-257.

[R9] `upstream/dkg/packages/mcp-dkg/README.md`: lines 1-6, 7-50, 141-204, 212-233, 235-300. `upstream/dkg/packages/mcp-dkg/src/index.ts`: lines 43-66. `upstream/dkg/packages/mcp-dkg/src/tools/memory-search.ts`: lines 47-82, 168-257, 259-294, 296-385. `upstream/dkg/packages/mcp-dkg/test/memory-search.test.ts`: lines 19-83, 89-117.

[R10] `upstream/dkg/packages/cli/skills/dkg-node/SKILL.md`: lines 254-283, 290-306, 308-418, 524-562, 618-625, 674-724.

[R11] `upstream/dkg/packages/query/README.md`: lines 1-12, 32-41. `upstream/dkg/packages/query/src/dkg-query-engine.ts`: lines 44-53, 84-131, 132-219, 232-300. `upstream/dkg/packages/query/src/query-handler.ts`: lines 33-39, 88-149, 151-245. `upstream/dkg/packages/query/src/sparql-guard.ts`: lines 1-7, 12-27, 123-160.

[R12] `upstream/dkg/docs/how-dkg-works/memory-layers.md`: lines 12-18, 20-47. `upstream/dkg/docs/use-dkg/knowledge-asset-lifecycle.md`: lines 8-18, 20-45, 47-68. `upstream/dkg/docs/use-dkg/publish-and-query.md`: lines 10-17, 25-57, 59-89. `upstream/dkg/docs/how-dkg-works/knowledge-assets.md`: lines 8-31. `upstream/dkg/docs/how-dkg-works/agents-and-trust.md`: lines 21-35. `upstream/dkg/docs/how-dkg-works/context-graphs.md`: lines 8-30.

[R13] `upstream/dkg/packages/chain/src/chain-adapter.ts`: lines 81-90, 92-148, 150-204. `upstream/dkg/packages/chain/src/evm-adapter-publish.ts`: lines 214-223, 275-320. `upstream/dkg/packages/publisher/src/merkle.ts`: lines 1-16, 26-41, 54-92. `upstream/dkg/packages/publisher/src/metadata.ts`: lines 46-72, 83-90, 110-155, 169-224, 229-260. `upstream/dkg/packages/publisher/src/verification-metadata.ts`: lines 8-45. `upstream/dkg/packages/publisher/src/dkg-publisher.ts`: lines 1508-1649, 1651-1720, 1751-1935, 2090-2130, 2144-2146, 2173-2248, 2257-2300, 2359-2399, 2682-2690, 2757-2858, 2858-2939.

[R14] `upstream/dkg/docs/references/api.md`: lines 8-17, 19-41. `upstream/dkg/packages/mcp-dkg/src/client.ts`: lines 1-7, 10-27, 46-68, 75-117.
