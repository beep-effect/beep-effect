...
export class DocumentIntakeState extends S.Class<DocumentIntakeState>($I`DocumentIntakeState`)(
   ...
   */
  // fallow-ignore-next-line unused-class-member -- invoked as state.<method>() inside registry.update callbacks in this module; fallow 3.16 misses S.Class instance-method receivers
