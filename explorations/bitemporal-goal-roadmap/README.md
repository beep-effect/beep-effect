...
Resume when knowledge-surface-automation Workstream D ships the now-view
roadmap projection. Decide the git-derived versus append-only event-ledger fork
at unpark.
...
- 2026-08-13: parked as structurally premature. Resume when
  knowledge-surface-automation Workstream D ships the now-view roadmap
  projection; decide the git-derived versus append-only ledger fork at unpark.
