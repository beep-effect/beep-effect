...
| Legal contradiction scope, priority, and correction deltas (`T1-F3,T3-F9,T4-F8`) | **re-routed 2026-08-04** → rides with `legal-position-relator-runtime` (compose, don't widen) | `legal-position-relator-runtime` *(proposed slug, not a path yet)* | P1 | — |
...
Route mix (as amended 2026-08-04): mixed×4, extend-goal×1, re-routed×1,
new-exploration×1, dup-skip×1, merged×1. Proposed slug count: **four** after
