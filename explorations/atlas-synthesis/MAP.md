...
| Provenance | `@beep/rdf/Vocab/Prov` | PROV-O `Activity`/`Agent`/`Derivation` | **HAVE** |
...
- HAVE bricks exist at the cited paths: `@beep/semantic-web/services/shacl-validation`
  ...
  `@beep/semantic-web/evidence` (`EvidenceAnchor`/`TextPositionSelector`),
