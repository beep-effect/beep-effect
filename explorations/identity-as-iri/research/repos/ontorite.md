...
- <local-research-checkout>/Ontorite/LICENSE
- <local-research-checkout>/Ontorite/README.md
- <local-research-checkout>/Ontorite/package.json
- <local-research-checkout>/Ontorite/src/main.tsx
- <local-research-checkout>/Ontorite/src/types/index.ts
- <local-research-checkout>/Ontorite/src/lib/common-ontologies.ts
- <local-research-checkout>/Ontorite/src/lib/file-access.ts
- <local-research-checkout>/Ontorite/src/lib/formats/index.ts
- <local-research-checkout>/Ontorite/src/lib/formats/jsonld.ts
- <local-research-checkout>/Ontorite/src/lib/formats/ntriples.ts
- <local-research-checkout>/Ontorite/src/lib/formats/quad-utils.ts
- <local-research-checkout>/Ontorite/src/lib/formats/rdfxml.ts
- <local-research-checkout>/Ontorite/src/lib/graph-utils.ts
- <local-research-checkout>/Ontorite/src/lib/ontology-diff.ts
- <local-research-checkout>/Ontorite/src/lib/persistence.ts
- <local-research-checkout>/Ontorite/src/lib/store.ts
- <local-research-checkout>/Ontorite/src/lib/turtle-parser.ts
- <local-research-checkout>/Ontorite/src/lib/turtle-serializer.ts
- <local-research-checkout>/Ontorite/src/lib/uri-utils.ts
- <local-research-checkout>/Ontorite/src/lib/validation.ts
- <local-research-checkout>/Ontorite/src/lib/vocab-autocomplete.ts
- <local-research-checkout>/Ontorite/src/lib/__tests__/format-detect.test.ts
- <local-research-checkout>/Ontorite/src/lib/__tests__/migration.test.ts
- <local-research-checkout>/Ontorite/src/lib/__tests__/turtle-parser.test.ts
- <local-research-checkout>/Ontorite/src/lib/__tests__/turtle-serializer.test.ts
- <local-research-checkout>/Ontorite/src/components/core/ClassCard.tsx
- <local-research-checkout>/Ontorite/src/components/core/ImportExport.tsx
- <local-research-checkout>/Ontorite/src/components/core/UnmappedTriplesTable.tsx
- <local-research-checkout>/Ontorite/src/components/core/ValidationPanel.tsx
- <local-research-checkout>/Ontorite/src/components/dialogs/CreateEdgeDialog.tsx
- <local-research-checkout>/Ontorite/src/components/dialogs/CreateEntityDialog.tsx
- <local-research-checkout>/Ontorite/src/components/dialogs/OntologyMetadataDrawer.tsx
- <local-research-checkout>/Ontorite/src/components/forms/ClassForm.tsx
- <local-research-checkout>/Ontorite/src/components/forms/ExtraTripleEditor.tsx
- <local-research-checkout>/Ontorite/src/components/forms/PropertyForm.tsx
- <local-research-checkout>/Ontorite/src/components/forms/VocabAutocomplete.tsx
- <local-research-checkout>/Ontorite/src/components/layout/App.tsx
- <local-research-checkout>/Ontorite/src/components/layout/OntologyList.tsx
