...
remain valid; extended-language subtags require their registered
primary-language prefix, while duplicate variants or extension singletons and
unregistered subtags do not.
