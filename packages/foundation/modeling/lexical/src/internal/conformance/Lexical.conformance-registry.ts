/**
 * Internal specification metadata used by the Lexical conformance facade.
 *
...
/**
 * Static source, profile, invariant, and evidence registry for Beep Lexical conformance.
 *
 * @internal
 * @category specifications
 * @since 0.0.0
 */
export const BeepLexicalConformanceAnnotation = {
  sources: [
    {
  ...
  invariants: [
    ...
    },
    {
      ...
      enforcement: [
        ...
        {
          kind: "runtime",
          validator: "SerializedEditorState",
        },
        {
          kind: "test",
          suite: "test/Lexical.model.test.ts",
    ...
    },
    {
      ...
      enforcement: [
        {
          kind: "runtime",
          validator: "SerializedEditorStateWire",
        },
        {
          kind: "test",
          suite: "test/Lexical.model.test.ts",
    ...
    },
    {
      ...
      enforcement: [
        {
          kind: "runtime",
          validator: "decodeEditorStateLossless",
        },
        {
          kind: "runtime",
          validator: "analyzeEditorStateCompatibility",
        },
        {
          kind: "test",
          suite: "test/Lexical.model.test.ts",
    ...
    },
    {
      ...
      enforcement: [
        ...
        {
          kind: "runtime",
          validator: "documentToEditorState",
        },
        {
          kind: "test",
          suite: "test/Lexical.codec.test.ts, test/Lexical.model.test.ts",
    ...
    },
    {
      ...
      testIds: [
        "test/Lexical.codec.test.ts#constructs-every-Markdown-list-projection-through-the-canonical-ListNode-payload-cases",
    ...
    },
    {
      ...
      testIds: [
        ...
        "test/Lexical.model.test.ts#rejects-values-outside-nullish-optional-field-domains",
      ],
    },
    {
      ...
      enforcement: [
        ...
        {
          kind: "runtime",
          validator: "editorStateToDocument",
        },
        {
          kind: "test",
