 ...
 *
 * **Example** (Generated field schema check)
 *
 * ```ts
 * import * as S from "effect/Schema"
 ...
 *
 * **Example** (Generated field on class)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (GeneratedByApp field schema)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (GeneratedByApp constructor usage)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (Insert-only generated field type)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 * @since 0.0.0
 */
export interface GeneratedByAppOnInsert<S extends S.Top>
  extends VariantSchema.Field<{
    readonly select: S;
    readonly insert: S;
    readonly json: S;
...
/**
 * A field generated by the application before insertion and immutable
 * afterwards.
 *
 * **Details**
 *
 * Present in `select`, `insert`, and `json`, but absent from `update`,
 * `jsonCreate`, and `jsonUpdate` because the server assigns the value once.
 *
 * **Example** (GeneratedByAppOnInsert constructor)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 *
 * const field = Model.GeneratedByAppOnInsert(S.String)
 * console.log(S.isSchema(field.schemas.insert))
 * ```
 *
 * @category constructors
 * @since 0.0.0
 */
export const GeneratedByAppOnInsert = <S extends S.Top>(schema: S): GeneratedByAppOnInsert<S> =>
  Field({
    select: schema,
    insert: schema,
    json: schema,
 ...
 *
 * **Example** (Sensitive field schema check)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (Sensitive field on class)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (optionalOption type annotation)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (optionalOption constructor usage)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 *
 * **Example** (FieldOption type annotation)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
 ...
 * For the JSON variants, it will also accept missing keys.
 *
 * **Example** (FieldOption constructor usage)
 *
 * ```ts
 * import * as S from "effect/Schema"
 * import * as Model from "@beep/schema/Model"
