...
export {
  /**
   * @deprecated Import {@link $isInsideCodeBlock} from @beep/editor/chat/code-fence.
   * @since 0.0.0
   */
  $isInsideCodeBlock,
  /**
   * @deprecated Import {@link $openCodeFence} from @beep/editor/chat/code-fence.
   * @since 0.0.0
   */
  $openCodeFence,
} from "./code-fence.ts";
...
export {
  /**
   * @deprecated Import {@link $selectionBlockType} from @beep/editor/chat/toolbar.
   * @since 0.0.0
   */
  $selectionBlockType,
  /**
