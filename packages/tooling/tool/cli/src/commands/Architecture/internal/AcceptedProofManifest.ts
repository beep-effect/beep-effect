...
export const acceptedProofFiles: ReadonlyArray<AcceptedProofFile> = [
  ...
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260813130540_baseline/migration.sql",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260813130540_baseline/snapshot.json",
    writer: "json",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260813143745_baseline-functions/migration.sql",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260813143745_baseline-functions/snapshot.json",
    writer: "json",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
  ...
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/test/migrate-on-boot.pglite.test.ts",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
