...
export const acceptedProofFiles: ReadonlyArray<AcceptedProofFile> = [
  ...
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/src/migrations/LawPracticeLegalPosition.ts",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
  ...
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260813173652_law_practice_st13_office_identity/migration.sql",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260813173652_law_practice_st13_office_identity/snapshot.json",
    writer: "json",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260807061034_law_practice_legal_position/migration.sql",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/drizzle/20260807061034_law_practice_legal_position/snapshot.json",
    writer: "json",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
  ...
  AcceptedProofFile.make({
    role: "db-admin",
    stage: "persistence",
    path: "packages/_internal/db-admin/test/integration/LawPracticeLegalPositionMigration.pglite.test.ts",
    writer: "template",
  }),
  AcceptedProofFile.make({
    role: "db-admin",
