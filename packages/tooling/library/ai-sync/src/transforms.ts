 ...
 *
 * **Example** (Convert Claude MCP to Codex)
 *
 * ```ts
 ...
 *
 * **Example** (Convert Claude MCP to Junie)
 *
 * ```ts
 ...
 *
 * **Example** (Convert Junie MCP to Claude)
 *
 * ```ts
 ...
 *
 * **Example** (Normalize instruction markdown)
 *
 * ```ts
 ...
 *
 * **Example** (Keep shared skill frontmatter)
 *
 * ```ts
