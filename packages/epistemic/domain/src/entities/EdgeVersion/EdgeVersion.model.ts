 ...
 * @since 0.0.0
 */
export class EdgeVersion extends ProductEntity.Entity<EdgeVersion>()(Epistemic.EdgeVersionId)(
  {
    evidenceScope: EdgeEvidenceScope.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.text(), pg.columnName("evidence_scope")),
    ...
    matterScope: EdgeMatterScope.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.text(), pg.columnName("matter_scope")),
    ...
    }).pipe(pg.bigint("number"), pg.columnName("recorded_at")),
    ...
    sourceClaimId: Epistemic.CandidateClaimId.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.integer(), pg.columnName("source_claim_id")),
    sourceEntityRef: EdgeEntityRef.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.text(), pg.columnName("source_entity_ref")),
    ...
    sourceObservationRef: EdgeObservationRef.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.text(), pg.columnName("source_observation_ref")),
    supersedesId: Epistemic.EdgeVersionId.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.integer(), pg.columnName("supersedes_id")),
    targetClaimId: Epistemic.CandidateClaimId.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.integer(), pg.columnName("target_claim_id")),
    targetEntityRef: EdgeEntityRef.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.text(), pg.columnName("target_entity_ref")),
    ...
    targetObservationRef: EdgeObservationRef.pipe(S.OptionFromNullOr)
      ...
      .pipe(pg.text(), pg.columnName("target_observation_ref")),
    ...
    }).pipe(pg.bigint("number"), pg.columnName("valid_from")),
