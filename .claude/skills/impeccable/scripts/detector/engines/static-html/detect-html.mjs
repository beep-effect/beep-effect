...
import { buildStaticStyleMap, buildStaticWindow, collectStaticCssText, StaticDocument } from "./css-cascade.mjs";
...
const STATIC_ELEMENT_RULES = [
  {
    ...
    run: (el, tag, style, window, customPropMap) =>
      checkElementBorders(
        ...
        style,
        null,
        resolveBorderRadiusPx(el, style, Number.parseFloat(style.width) || 0, window),
        el
      ),
  },
  {
