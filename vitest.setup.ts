...
// Property-test run floors and seeds now flow through @beep/fc-runs
// (BEEP_FC_NUM_RUNS / BEEP_FC_SEED) into per-test `{ arbitrary: ... }`
// options; the native effect Arbitrary model has no global configuration.
