...
export async function getPackage(): Promise<string | undefined> {
  return runtime.registerPackage({
    ...
    baseProviderVersion: "0.2.2",
    baseProviderDownloadUrl: "",
    packageName: "ghaRunners",
    packageVersion: "7.10.1",
    base64Parameter:
      "ewogICJtb2R1bGUiOiAiZ2l0aHViLWF3cy1ydW5uZXJzL2dpdGh1Yi1ydW5uZXIvYXdzIiwKICAidmVyc2lvbiI6ICI3LjEwLjEiLAogICJwYWNrYWdlTmFtZSI6ICJnaGFSdW5uZXJzIgp9",
  });
}
