...
pulumi.runtime.registerResourceModule("ghaRunners", "index", _module);
pulumi.runtime.registerResourcePackage("ghaRunners", {
  version: utilities.getVersion(),
  constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
    if (type !== "pulumi:providers:ghaRunners") {
