...
entry, and add the `@beep/mcp-kit/test/Conformance` port. The gov-legal and professional-desktop integration tests follow the declared-failure projection
(envelope in `content[].text`).
