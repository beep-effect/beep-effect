...
- P0 is a hard contract gate; do not infer donor availability from old paths.
  ...
  the checked-in `assets/ontology-prototype/` tree is the schema-first idiom
