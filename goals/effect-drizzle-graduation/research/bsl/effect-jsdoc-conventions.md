...
4. **Examples expose source topology.** Among 144 Example import statements, 49
   are relative imports, including the internal statics module, local source files,
   and local fixtures. Effect has zero relative JSDoc imports. Published examples
