...
| P3 Yeet: PR to mergeable | pending | Publish the packet's runbook/evidence updates through yeet and drive the PR to mergeable. | `bun run beep yeet monitor` reports `merge-ready: yes` (the aggregate hard gate); zero unresolved review threads. |
