# Provisional full owner: r28-cli-internal-root-tmpfs-discovered-classified-skip

Native P2 data-only correction to an existing stable candidate design. Frozen
HEAD `93217d998f851e2e93d9864e2b5315552eaa58a7`; main
`d1b4d769fbaffddd55717f3b1ba461897dd545c5`. No current design or raw correction
is changed. The old26/6 finding remains the exact selected-pair projection;
this draft accounts for the complete connected312/13 owner. Full evidence,
source/row/proof hashes and exact proposed row are bound in
...
private migrations in one batch, preserve public codecs and original correction
history, and allocate guard credit as stated. This full-owner correction is
native P2 evidence for parent integration, not a new independent correction.
