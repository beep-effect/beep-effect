...
- Stable id: `create-package-scaffold-shape`.
- Actual owner: private schema `ScaffoldShape` at
  `packages/tooling/tool/cli/src/commands/CreatePackage/CreatePackage.command.ts:477-486`.
- Full members: `appKind`, `lab`, `withStoriesTsconfig`.
- Frozen HEAD: `93217d998f851e2e93d9864e2b5315552eaa58a7`.
- Frozen main: `d1b4d769fbaffddd55717f3b1ba461897dd545c5`.
- Source SHA-256:
  `8b3108c7db97b1817f9f1504fc1e8d34ce3c72219b18c456e609920bb4203b75`.
- Companion proof:
  `data/design-refresh-2026-09-09-r28-create-package-scaffold-shape.md`.

This P2 provisional corrects an existing D1 record. It is not yet an
admitted current design or independent P3 receipt. No implementation has
occurred. All product citations below refer to CreatePackage.command.ts
...
Tier 1 internal tooling work after independent correction/admission and
design review. The largest risks are changing ordered template/file output,
...
Promote the existing stable id from its false D1 note to the complete
24/11 cluster, preserving historical row bytes under parent integration.
Do not create a second narrow lab/stories qualification or absorb the
separately exported TemplateContext clusters. No canonical mutation or
independent P3 acceptance is included in this provisional.
