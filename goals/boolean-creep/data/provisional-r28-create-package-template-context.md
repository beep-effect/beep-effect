# TemplateContext full-owner provisional

Native P2 proposal for expanded stable id `create-package-template-type-flags`.
Supersedes the narrower app-kind row and the independently corrected
lab/ecosystem pair only after parent integration. Current designs remain intact.
Frozen source HEAD `93217d998f851e2e93d9864e2b5315552eaa58a7`, main
`d1b4d769fbaffddd55717f3b1ba461897dd545c5`. See the complete source/fixture/hash
receipt in `data/design-refresh-2026-09-09-r28-cli-retained-qualified-gap-audit.md`.
No implementation or independent review is claimed.
...
payloads. Parent must archive the superseded app-kind and lab/ecosystem rows
with their exact history/correction receipt, admit this complete owner, copy
this provisional into the surviving current design and obtain replacement P3.
