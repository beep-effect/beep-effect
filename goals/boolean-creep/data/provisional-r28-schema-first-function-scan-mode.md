...
- Stable id: `r3-tooling-schema-first-fn-eligibility`.
- Proposed current owner: `packages/tooling/tool/cli/src/commands/Lint/internal/SchemaFirstScan.ts:239`,
  `appendFunctionEntries`, actual members `inspectFnSchema`, `inspectNullReturn`.
- Proposed correction: existing D1 → qualified E4, 4 representable /3 legal,
  derived, internal, Tier1, LiteralKit. No canonical admission/status change.
- Source: `93217d998f851e2e93d9864e2b5315552eaa58a7`;
  corpus: `origin/main@d1b4d769fbaffddd55717f3b1ba461897dd545c5`.
- Adjudication: `data/design-refresh-2026-09-09-r28-lint-scan-values.md`.
- Provisional native P2 only. Independent R28 owner confirmation/correction and
  independent P3 are still required; this file is not a current admitted design.
...
The old seed's independent-gates rationale is disproven, but native adjudication
alone is not independent acceptance. Parent must obtain the R28 owner report or
bounded independent correction before admitting this D1→qualified row and moving
this provisional file into designs/<stable-id>.md; independent P3 follows.
No source implementation, canonical status advance or old-receipt revision is
