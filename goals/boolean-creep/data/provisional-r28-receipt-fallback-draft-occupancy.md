...
- Stable id: `receipt-fallback-draft-occupancy`.
- Actual enclosing symbol: `reconcileReceiptFallbacks`.
- Owner: sibling Option values in the synchronous block at
  `packages/agents/client/src/Chat.atoms.ts:1017-1053`.
...
- Source SHA-256:
  `91d8040ca676201732ecab34e6a8de8951598b1495ac800529b8609d82a0ad6a`.
- Exact inferred-type proof:
  `data/design-refresh-2026-09-09-r28-receipt-occupancy-type.md`.

P2 correction draft only; pending parent integration and independent review.
The current design and prior finalized audit remain historical immutable
inputs to this correction. No product implementation has occurred.
...
all supported producer behavior. Review and integrate the 6/3 correction
before replacing the current 4/3 design, keeping its prior bytes and the
finalized audit as historical evidence. No new canonical id or overlapping
cluster is required; independent correction and P3 review remain pending.
