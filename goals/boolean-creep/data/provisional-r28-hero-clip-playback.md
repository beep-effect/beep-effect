...
- Existing id: `r2-apps-hero-clip-playback`.
- Actual owner: private React component `HeroClipLayer`,
  `apps/oip-web/src/components/HeroVideo.tsx:208-277`.
- Actual members: `active`, `layered`, `playing`, `posterHidden`.
- Source HEAD: `93217d998f851e2e93d9864e2b5315552eaa58a7`.
- Main: `d1b4d769fbaffddd55717f3b1ba461897dd545c5`.
- Source file SHA-256:
  `e794854408bf5c76eb73c9a25a021c760ff1f082282ba0021c48990c2b9f469d`.
- Companion audit:
  `data/design-refresh-2026-09-09-r28-agent-app-owner-boundaries.md`.

This P2 draft replaces the incomplete three-member 8/4 design only after
independent correction/admission and parent integration. It is not a current
canonical design or a P3 receipt. No implementation has occurred.
...
D1 projection is wholly contained and must be archived as superseded if
this full correction is admitted. Its prior reasoning remains historical.
...
requires the repo's recorded browser QA flow and relevant focused component
checks, followed by full `@beep/oip-web` package verification. This design-only
task executes none of those product commands and claims no acceptance result.

# Risk

Tier 1 app UI work after independent correction/admission and review.
...
Admission must supersede `hero-clip-layer-flags` as a contained projection,
and replace the current three-member design only with its original bytes
archived under the integration receipt. The separate HeroVideoState D1
