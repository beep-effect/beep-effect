...
- file:line: `packages/foundation/ui-system/ui/src/components/todo-item.tsx:133`
- symbol: `TodoItem.metadata`
- members: `priority`, `hasDueDate`, `hasProject`, `hasLabels`, `hasSubtasks`, `hasMetadata`
- evidence classes:
  - E4 at `todo-item.tsx:133-149` — metadata visibility is the OR of non-none priority, date presence, project presence, nonempty labels, and nonempty subtasks.
