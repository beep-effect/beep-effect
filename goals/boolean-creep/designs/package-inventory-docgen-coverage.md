# R38 authoritative docgen owner location update

Current frozen HEAD ab77f10cb74ad96404b05d1ab5a1d4968cef847b / main9a1bd3805574bca087d4da09ece4a628038afb27. Metadata-only: retain designed16/10, derived/persisted, tagged union, Tier2 and the full migration/compatibility contract below. This section supersedes older numeric locations for JSDocDocumentationInventory.ts only; it grants no P3 or implementation credit.

Complete PackageInventory type152–178, docgenCoverage JsonRecord161. Current conditional config probe/read1309–1310, actual configured/missing-config object1349–1354, missing-package writer1361–1394 with Boolean object1372–1377. Exported builder1593–1662, artifact writer1670–1713; optional mirror options273–274, same-scan mirror writes1705–1706. Primary writes1694/1697 remain ahead of both mirrors. Missing packageFFFF, missing configFFFT and all eight configured tuples are unchanged. No raw JSON/default narrowing or payload changes.

Exact comparison with the retained bed30c6 source proves original lines41–735 map+1; original772–1561 map+36;1563–1638 map+36;1640–1696 map+36. Thus all original owner, guards, constructors, body consumers and mirror locations in the retained design map+36; original type/options lines map+1. Changed signature lines1562/1639 are current1598/1675 and do not alter Boolean owner or output projection. Earlier detector edits account for the shift. Other files' older mappings remain under their existing provenance; this bounded audit does not assert a fresh global citation audit.
