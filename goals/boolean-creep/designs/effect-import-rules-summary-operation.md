...
Complete owner source byte-identical to the baseline. Retain successful-summary 4/3, independent strictFailure, all payloads/defaults and encoded property order. Raw options and pre-summary conflict diagnostics remain unrestricted request contracts.
