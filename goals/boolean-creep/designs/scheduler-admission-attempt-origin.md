...
- file:line: `packages/tooling/tool/cli/src/internal/repo-run/QualityScheduler.ts:1732`
- symbol: `AdmissionAttempt`
- members: `originBusy`, `admitted`
- evidence: E1 at `QualityScheduler.ts:1748-1770` — failure to acquire the
...
- `QualityScheduler.ts:1595-1600` — retain the generic admitted payload and
...
- `QualityScheduler.ts:1732-1771` — delete `AdmissionAttempt`; return
...
- `QualityScheduler.ts:1754-1760` — preserve both ownership guards: an error
...
- `QualityScheduler.ts:1912-1920` — consume the shared outcome exhaustively in
  promotion; retain promotion-transition processing and its error-path release
  only for admitted.
- `QualityScheduler.ts:1990-2027,2050-2095,2245-2256` — the downstream wait,
...
- `QualityScheduler.ts:2075-2092,2097-2124,2234-2242` — preserve the new v3
