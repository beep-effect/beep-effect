...
`$HOME/YeeBois/references/effect/`, index them with graft in workspace mode with a nightly
...
- Graft facts the design depends on were read from `$HOME/YeeBois/dev/Graft` at v0.18.0; re-verify
