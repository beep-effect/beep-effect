# folio-lynx-taxonomy-browse — inherited source corpus
...
Related source authority for Lynx artifact vetting and licensing:
`explorations/lynx-lkg-ontology-grounding/research/SOURCES.md`.
