...
Lifecycle: `active`; P2 complete 2026-08-24, P3 in progress
...
10. [`research/P3-DESIGN.md`](./research/P3-DESIGN.md) - organization
    ...
    proof plan.
11. [`research/OPPORTUNITIES.md`](./research/OPPORTUNITIES.md) - P1 and P2
...
Admission defense in depth is in progress. This PR stages `heavy.yml` through a
local reusable-workflow call and flips the controller to the existing selected
organization group. The follow-up PR pins the call to `heavy.yml@main`; the
operator enables the three-workflow group restriction at that cutover. P4 owns
the live JIT replay run; its operator-controlled probe is now implemented.
