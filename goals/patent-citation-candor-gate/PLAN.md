...
| P3 Yeet: PR to mergeable | complete | Ship each rung through `bun run beep yeet publish --pr` and drive checks/review to mergeable. | Completion gate satisfied (PR mergeable, checks green, review clean). |
