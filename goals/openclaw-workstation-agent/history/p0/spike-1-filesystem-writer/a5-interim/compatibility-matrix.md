...
| `defaultTo` declared | HARNESS-ERROR | declared send lacked positive username-resolution evidence | `a5-defaultTo-declared.log` | yes |
| `defaultTo` undeclared | HARNESS-ERROR | undeclared send lacked positive username-resolution evidence | `a5-defaultTo-undeclared.log` | yes |
