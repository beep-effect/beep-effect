...
relabel the sample as a seven-day interval.
...
| Dead-owner takeover under 5 minutes | The installed watcher polls every 30 seconds and treats a lease as stale at 240 seconds, bounding detection at 270 seconds. Seven focused tests cover stale detection, CAS transfer, resume, retired-owner refusal, abandoned-claim recovery, and cache-placeholder repair. No dead-owner incident occurred in the sample. | Satisfied for the absent incident class by the deterministic bound and takeover tests. |
