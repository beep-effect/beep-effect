# CLI and config runner dependency review

The explicit CLI and architecture config test-runner dependencies add 18
direct task edges across 18 dependency lists. Each added edge targets the
