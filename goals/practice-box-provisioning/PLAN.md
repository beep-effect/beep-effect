...
| P2 Verify | in-progress | Dry-run plan artifact against the live tenant; repeat-run identity; operator-attended first apply; all-`Noop` re-plan; package-verify handoffs. | Verification matrix green; apply receipt in `history/`. |
