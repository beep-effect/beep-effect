...
| 4 (recorded, judged) | **CAPTURE-GREEN** 82/82, 0 app console errors; extract clock `beacon` high (10.2 ms residual), 76 artifacts; judge `gpt-5.6-sol` high → **0 findings, `requiredCount: 0`** — exit gate met | — |
