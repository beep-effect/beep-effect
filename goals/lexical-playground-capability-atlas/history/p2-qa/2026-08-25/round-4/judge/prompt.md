# Browser QA Vision Judge — Round 4

You are the vision judge for browser QA round 4 of Professional Desktop editor-proof panel: @beep/editor capability profiles (lexical-playground-capability-atlas P2, round 4 after round-3 fixes).
Round directory: `/home/elpresidank/YeeBois/projects/beep-effect15/.beep/qa/round-4`
...
- **open-panel-through-dock**: recorder collector CORS console errors (not app traffic): 16
- **minimal-toolbar-help-and-readable-content**: recorder collector CORS console errors (not app traffic): 2
- **minimal-disabled-authoring-paths**: recorder collector CORS console errors (not app traffic): 16
- **switch-to-document-proof-keeps-content**: recorder collector CORS console errors (not app traffic): 6
- **every-command-mouse-and-keyboard**: recorder collector CORS console errors (not app traffic): 130
- **slash-menu-and-markdown-shortcut**: recorder collector CORS console errors (not app traffic): 14
- **keyboard-focus-order-and-accessible-names**: recorder collector CORS console errors (not app traffic): 10
- **canonical-json-import-lifecycle**: recorder collector CORS console errors (not app traffic): 16
- **narrow-viewport-and-touch**: recorder collector CORS console errors (not app traffic): 24
- **no-network-egress**: foreign requests observed: 0
...
```
{
  ...
  "findings": [
    {
      "id": "R4-01",            // R<round>-<nn>, zero-padded, ordered by severity
