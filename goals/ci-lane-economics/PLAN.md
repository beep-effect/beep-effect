...
| --- | --- | --- | --- |
| P0 Cache-warm census | pending | Re-measure every required lane's p50/p95 on cache-warm PR and push waves. | A lane-time table from >=1 representative week (or >=10 waves) with hit rates, replacing all cold-cache numbers. |
...
| P3 Evidence + close | pending | Prove the charter on live waves and close. | No required job p50 > 20 minutes over a week; reflection lands; lifecycle completed-retained. |
