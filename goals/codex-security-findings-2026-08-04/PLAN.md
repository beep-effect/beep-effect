...
| P1 capture | complete | Capture all live findings via signed-in Chrome. | 27 IDs and sanitized reports reconcile: 13 Medium, 7 Low, 7 Informational. |
...
test "$(find goals/codex-security-findings-2026-08-04/findings -maxdepth 1 -name 'CSF-*.md' | wc -l | tr -d ' ')" = 27
