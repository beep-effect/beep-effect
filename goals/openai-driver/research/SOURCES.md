...
| `@beep/identity` composers | `packages/foundation/modeling/identity/src/packages.ts` (`$AnthropicId` precedent) | the scaffold registers `$OpenAiId`; verify at P1 |
