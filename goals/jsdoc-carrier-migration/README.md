...
that contains a legacy carrier **anywhere in the file**, and 75% of source files contain one.
...
rebasing a 1,935-file diff against a moving `main`. Residue fixes go in `overrides.jsonl`, not the
working tree.
