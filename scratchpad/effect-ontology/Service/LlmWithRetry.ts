...
export interface GenerateObjectWithRetryOptions<
  StructuredOutputSchema extends S.Encoder<Record<string, unknown>, unknown>
> {
...
> {
    ...
    const schemaHash = sha256Sync(JSON.stringify(S.toJsonSchemaDocument(schema)))
    ...
    return yield* llm.generateObject({
      ...
      Effect.tap(Effect.fn("LlmWithRetry.annotateSuccess")(function* (response) {
