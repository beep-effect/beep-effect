...
describe("progress and workflow schema boundaries", () => {
  it.effect("constructs canonical backpressure defaults and initializes handler state", () =>
    Effect.gen(function* () {
  ...
  it.effect("constructs schema defaults for entity resolution and progress builder state", () =>
    Effect.gen(function* () {
