...
describe("grounding provenance", () => {
  it.effect(
    ...
    Effect.fnUntraced(function* () {
      const activity = yield* decodeObjectRef("urn:beep:test:activity");
      const source = yield* decodeObjectRef("urn:beep:test:source:chunk:0");
      const rejectedArtifact = yield* decodeObjectRef("urn:beep:test:artifact:rejected");
      const supportedArtifact = yield* decodeObjectRef("urn:beep:test:artifact:supported");
      const rejectedObservationId = yield* decodeObjectRef("urn:beep:test:observation:rejected");
      const supportedObservationId = yield* decodeObjectRef("urn:beep:test:observation:supported");
      const rejectedEvidence = yield* decodeEvidenceSpan({
        text: "Ada",
        startChar: 0,
        endChar: 3,
      });
      const supportedEvidence = yield* decodeEvidenceSpan({
        text: "Lovelace",
        startChar: 4,
        endChar: 12,
      });
  ...
  it.effect(
    ...
    Effect.fnUntraced(function* () {
      const activity = yield* decodeObjectRef("urn:beep:test:activity:claim");
      const source = yield* decodeObjectRef("urn:beep:test:source:claim");
      const artifact = yield* decodeObjectRef("urn:beep:test:artifact:claim");
      const observationId = yield* decodeObjectRef("urn:beep:test:observation:claim");
      const evidence = yield* decodeEvidenceSpan({
        text: "Lovelace",
        startChar: 4,
        endChar: 12,
      });
  ...
  it.effect(
    ...
    Effect.fnUntraced(function* () {
      const activity = yield* decodeObjectRef("urn:beep:test:activity:durable");
      const source = yield* decodeObjectRef("urn:beep:test:source:durable");
      const provenance = yield* decodeObjectRef("urn:beep:test:artifact:durable");
      const id = yield* decodeObjectRef("urn:beep:test:observation:durable");
