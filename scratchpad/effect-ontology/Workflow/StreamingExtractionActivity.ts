  ...
  Activity.make({
    ...
    execute: Effect.gen(function*() {
      ...
      const sourceContent = yield* storage.get(sourceKey).pipe(
        Effect.flatMap((opt) => requireContent(O.fromNullishOr(opt), sourceKey))
      )
