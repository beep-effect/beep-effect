 ...
 * ```
 *
 * @param type - Artifact kind whose persisted filename is required.
 * @returns The stable filename, including its extension.
 * @deprecated Use {@link OutputType.filename}.
 * @category interop
 * @since 0.0.0
 */
export const getOutputFilename = OutputType.filename;
 ...
 * ```
 *
 * @param type - Artifact kind whose documentation is required.
 * @returns A concise description suitable for manifests and diagnostics.
 * @deprecated Use {@link OutputType.description}.
 * @category interop
 * @since 0.0.0
 */
export const getOutputDescription = OutputType.description;
