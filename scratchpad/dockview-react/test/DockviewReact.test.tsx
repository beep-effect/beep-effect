...
import { type DockAtomGraph, type DockPanelProps, DockviewReact } from "../src/index.ts";
import { activeResizeObserverCount, resize } from "./setup.dom.ts";
...
describe.sequential("DockviewReact", () => {
